...
# For image 'ZoomMechVent_DS25_P1.png', zeroZero = (16, 79), secondYPixels = (16, 187), secondXPixels = (81, 79)
def map_to_units(filteredNpArray):
  zeroZero = (16, 79)
  secondYPixels = (16, 187)
  secondXPixels = (81, 79)
...
def main():
   # USER: rotate the image before you import it in here
    ...
    RGBim = Image.open("ZoomMechVent_DS25_P1.png").convert('RGB')
    ...
    # Find all green pixels hue range
    # USER: update HSV you will accept,
    lo,hi = 40,58
